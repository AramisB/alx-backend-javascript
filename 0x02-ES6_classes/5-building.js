...
// If a class that extends from it does not have a evacuationWarningMessage method, throw an error
// with the message Class extending Building must override evacuationWarningMessage
